...
INSERT INTO Cus_res (customerID, restaurantID, OrderDetail, OrderID)
VALUES
    ...
    (21, 6, 'Deliver a family-sized pizza with pepperoni, mushrooms, and extra cheese as soon as possible.', 3),
    (38, 5, 'Prepare a seafood platter with lobster, shrimp, and crab for a special celebration.', 4),
    (24, 3, 'I need a gluten-free, vegan-friendly sandwich with plenty of veggies for lunch.', 5),
    ...
    (1, 14, 'Prepare a three-course meal for a romantic dinner tonight, including a vegetarian option.', 9),
    ...
    (5, 27, 'Prepare a seafood platter with oysters, crab, and shrimp for a special occasion.', 41),
    ...
    (15, 4, 'Prepare a three-course meal for a special occasion, including vegetarian options.', 72),
